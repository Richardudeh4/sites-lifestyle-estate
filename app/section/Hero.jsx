...
const Hero = () => {
 ...
 <button className="py-2 w-28 text-center justify-center border text-white border-white bg-[#B1935C] flex space-x-4"><h1>Explore </h1><Image src={Vector} alt="left-arrow" width={15} height={15}/></button>
    <div className="relative mx-8 z-20 px-8 shadow-xl outline-none bg-[#D9D9D9] padding mt-16 mb-0">
      <Modal className=""/>
    </div>
